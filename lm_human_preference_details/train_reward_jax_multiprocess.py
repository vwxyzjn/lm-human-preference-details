...
class Args:
    ...
    track: bool = True  # TODO: change back to False
...
def create_initial_reward_state_and_models(init_key, args):
    ...
    """Create reward model and initial reward state."""
...
def get_reward(params: RewardModelParams, query_responses_ids: jnp.ndarray, args: Args):
...
def normalize(
    args, tokenizer, pretrained_model, reward_state, iter_dataloader, generation_config
):
    ...
    def get_normalization_stats(reward_state):
        ...
        for query_responses in sample_queries_responses:
            rewards.append(get_reward(reward_state.params, query_responses, args))
...
def train_step(state, batch):
    ...
    def loss_function(params):
        logits = get_reward(params, query_responses_ids, tokenizer)
    ...
    for global_step, train_batch in enumerate(train_iter):
        ...
        if (
            ...
            for val_batch in val_iter:
                ...
                val_loss, val_metrics = p_val_step(reward_state, val_batch)
